...
from agents.dqn.model import DQN, Transition, ReplayMemory
...
def main(env_name):
    ...
    torch.save(torch.tensor(rewards_over_time), f"{env_name}_rewards_over_time.pt")
    torch.save(policy_net, f"{env_name}_policy_net.pt")
    torch.save(target_net, f"{env_name}_target_net.pt")
